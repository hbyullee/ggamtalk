	...
	public void onExecute(int what, JsonObject resultJO) {
		...
		case Config.getSession:
			...
			String query = String.format("UPDATE app_user_list SET user_nick='%s' WHERE user_id='%s' and app_id='%s'",
					params.getString("user_nick"), params.getString("user_id"), params.getString("app_id"));
		...
		case Config.setNickApp:
			...
			String query2 = String.format("UPDATE channel_user_list SET user_nick='%s' WHERE user_id='%s' and app_id='%s'",
					params.getString("user_nick"), params.getString("user_id"), params.getString("app_id"));
